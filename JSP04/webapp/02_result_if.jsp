...
<%
request.setCharacterEncoding("UTF-8");	//POST방식에서만 필요
String userName = request.getParameter("userName");
String color = request.getParameter("color");	//요청 파라미터의 color값을 읽음
...
<c:set var="colorValue2" value="black"></c:set>	<%-- 요청 파라미터에 color가 없을 때 사용할 기본 값 --%>
