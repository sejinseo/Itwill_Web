...
<html>
	...
	<body>		
		...
		<%--
		maxFractionDigit : 표현할 수 있는 소수점 이하 최대 자릿수.
		groupingUsed : 1000자리 구분자를 사용할 지 여부.
		--%>	
		...
		<br>
		percentage type: number type: <fmt:formatNumber value="1" type="percent"></fmt:formatNumber>
		<script>
		</script>
	</body>
</html>