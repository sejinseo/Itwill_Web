...
<html>
	...
	<body>		
		...
		<%
		// form 에서 POST 방식으로 보낸 데이터 (요청 파라미터)의 한글을 제대로 처리하기 위해
		request.setCharacterEncoding("UTF-8");	//생략 불가	
		%>
		...
		<%-- 2. 요청 파라미터(request parameter) 값들로 Java Bean 객체의 프로퍼티 설정 --%>
		<%-- 
		...
		<%-- 요청 파라미터를 모두 이용해서 bean 객체 b2의 모든 속성들의 값을 설정 --%>
		...
		글 작성자: <jsp:getProperty property="writer" name="b2"/> <br>
		</div>
